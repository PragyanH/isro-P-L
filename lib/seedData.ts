// ─── Seed Data ────────────────────────────────────────────────────────────────
// Static baseline district data for Karnataka and India state summaries.
// These values are seeded for prototype purposes.
// The recompute logic (climateEngine.ts) operates on these as starting points.

import type { DistrictBaseline } from './climateEngine';

// ─── Karnataka Districts ──────────────────────────────────────────────────────
export const karnatakaDistricts: DistrictBaseline[] = [
  ...
  { name: 'Bagalkot',         baselineRainfall: 58,  baselineTemp: 30.8, rainfallStdDev: 23, tempStdDev: 1.9, floodRiskBase: 0.12, droughtRiskBase: 0.45, activeMonsoonDays: 9,  breakMonsoonDays: 13, predictionConfidence: 0.76 },
  { name: 'Gadag',            baselineRainfall: 65,  baselineTemp: 30.0, rainfallStdDev: 26, tempStdDev: 1.7, floodRiskBase: 0.15, droughtRiskBase: 0.38, activeMonsoonDays: 10, breakMonsoonDays: 11, predictionConfidence: 0.78 },
  { name: 'Haveri',           baselineRainfall: 80,  baselineTemp: 29.5, rainfallStdDev: 30, tempStdDev: 1.6, floodRiskBase: 0.18, droughtRiskBase: 0.25, activeMonsoonDays: 12, breakMonsoonDays: 9,  predictionConfidence: 0.80 },
  ...
  { name: 'Udupi',            baselineRainfall: 300, baselineTemp: 27.0, rainfallStdDev: 85, tempStdDev: 1.1, floodRiskBase: 0.58, droughtRiskBase: 0.04, activeMonsoonDays: 21, breakMonsoonDays: 3,  predictionConfidence: 0.71 },
  ...
  { name: 'Chikkamagaluru',   baselineRainfall: 160, baselineTemp: 26.5, rainfallStdDev: 50, tempStdDev: 1.2, floodRiskBase: 0.38, droughtRiskBase: 0.10, activeMonsoonDays: 16, breakMonsoonDays: 5,  predictionConfidence: 0.76 },
  ...
  { name: 'Chamarajanagara',  baselineRainfall: 62,  baselineTemp: 29.0, rainfallStdDev: 24, tempStdDev: 1.5, floodRiskBase: 0.10, droughtRiskBase: 0.40, activeMonsoonDays: 9,  breakMonsoonDays: 12, predictionConfidence: 0.79 },
  ...
  { name: 'Chikkaballapura',  baselineRainfall: 65,  baselineTemp: 28.5, rainfallStdDev: 25, tempStdDev: 1.4, floodRiskBase: 0.11, droughtRiskBase: 0.33, activeMonsoonDays: 10, breakMonsoonDays: 10, predictionConfidence: 0.80 },
  { name: 'Kolar',            baselineRainfall: 60,  baselineTemp: 29.5, rainfallStdDev: 24, tempStdDev: 1.5, floodRiskBase: 0.09, droughtRiskBase: 0.38, activeMonsoonDays: 9,  breakMonsoonDays: 12, predictionConfidence: 0.79 },
  ...
  { name: 'Koppal',           baselineRainfall: 50,  baselineTemp: 32.0, rainfallStdDev: 21, tempStdDev: 2.0, floodRiskBase: 0.07, droughtRiskBase: 0.58, activeMonsoonDays: 7,  breakMonsoonDays: 15, predictionConfidence: 0.74 },
  { name: 'Yadgir',           baselineRainfall: 44,  baselineTemp: 33.5, rainfallStdDev: 19, tempStdDev: 2.2, floodRiskBase: 0.06, droughtRiskBase: 0.68, activeMonsoonDays: 6,  breakMonsoonDays: 17, predictionConfidence: 0.72 },
...
// ─── India State-Level Summary ────────────────────────────────────────────────
// One stability score + summary per state for the Home page map.
...
export const indiaStateSummaries: StateSummary[] = [
  { name: 'Andhra Pradesh',       code: 'AP', stabilityScore: 62, rainfall: 88,  temp: 30.2, primaryRisk: 'Cyclone risk' },
  { name: 'Arunachal Pradesh',    code: 'AR', stabilityScore: 78, rainfall: 280, temp: 18.5, primaryRisk: 'Landslide' },
  ...
  { name: 'Chhattisgarh',         code: 'CG', stabilityScore: 67, rainfall: 115, temp: 28.8, primaryRisk: 'Moderate' },
  { name: 'Goa',                  code: 'GA', stabilityScore: 74, rainfall: 310, temp: 27.0, primaryRisk: 'Flood risk' },
  { name: 'Gujarat',              code: 'GJ', stabilityScore: 58, rainfall: 55,  temp: 32.0, primaryRisk: 'Drought' },
  { name: 'Haryana',              code: 'HR', stabilityScore: 61, rainfall: 48,  temp: 31.5, primaryRisk: 'Drought' },
  { name: 'Himachal Pradesh',     code: 'HP', stabilityScore: 72, rainfall: 160, temp: 15.2, primaryRisk: 'Landslide' },
  { name: 'Jharkhand',            code: 'JH', stabilityScore: 60, rainfall: 108, temp: 28.0, primaryRisk: 'Drought' },
  ...
  { name: 'Madhya Pradesh',       code: 'MP', stabilityScore: 64, rainfall: 82,  temp: 30.0, primaryRisk: 'Drought' },
  { name: 'Maharashtra',          code: 'MH', stabilityScore: 60, rainfall: 90,  temp: 29.8, primaryRisk: 'Mixed' },
  { name: 'Manipur',              code: 'MN', stabilityScore: 69, rainfall: 190, temp: 21.5, primaryRisk: 'Landslide' },
  { name: 'Meghalaya',            code: 'ML', stabilityScore: 76, rainfall: 350, temp: 20.0, primaryRisk: 'Flood' },
  { name: 'Mizoram',              code: 'MZ', stabilityScore: 73, rainfall: 240, temp: 21.0, primaryRisk: 'Landslide' },
  { name: 'Nagaland',             code: 'NL', stabilityScore: 71, rainfall: 200, temp: 20.5, primaryRisk: 'Landslide' },
  { name: 'Odisha',               code: 'OD', stabilityScore: 52, rainfall: 120, temp: 30.5, primaryRisk: 'Cyclone/Flood' },
  { name: 'Punjab',               code: 'PB', stabilityScore: 63, rainfall: 52,  temp: 30.0, primaryRisk: 'Drought' },
  { name: 'Rajasthan',            code: 'RJ', stabilityScore: 38, rainfall: 28,  temp: 35.5, primaryRisk: 'Critical drought' },
  { name: 'Sikkim',               code: 'SK', stabilityScore: 68, rainfall: 220, temp: 12.0, primaryRisk: 'Glacial risk' },
  ...
  { name: 'Tripura',              code: 'TR', stabilityScore: 70, rainfall: 185, temp: 25.5, primaryRisk: 'Flood' },
  { name: 'Uttar Pradesh',        code: 'UP', stabilityScore: 55, rainfall: 62,  temp: 30.5, primaryRisk: 'Flood/Drought' },
  { name: 'Uttarakhand',          code: 'UK', stabilityScore: 67, rainfall: 175, temp: 14.0, primaryRisk: 'Glacial/Flood' },
  { name: 'West Bengal',          code: 'WB', stabilityScore: 54, rainfall: 155, temp: 29.0, primaryRisk: 'Flood/Cyclone' },
  { name: 'Jammu and Kashmir',    code: 'JK', stabilityScore: 66, rainfall: 140, temp: 10.0, primaryRisk: 'Glacial risk' },
  { name: 'Ladakh',               code: 'LA', stabilityScore: 72, rainfall: 20,  temp: 5.0,  primaryRisk: 'Glacial risk' },
  { name: 'Delhi',                code: 'DL', stabilityScore: 45, rainfall: 42,  temp: 32.5, primaryRisk: 'Heatwave/Drought' },
  { name: 'Puducherry',           code: 'PY', stabilityScore: 64, rainfall: 82,  temp: 30.5, primaryRisk: 'Cyclone' },
];

// ─── Karnataka Historical Incident (for PoC page) ────────────────────────────
export const karnatakaIncident = {
  name: '2019 North Karnataka Floods',
  location: 'Belagavi District',
  coordinates: [74.4977, 15.8497] as [number, number],
  date: 'August 2019',
  ...
  recordedRainfall: 280,   // mm in the critical 7-day window
  recordedTemp: 26.5,      // °C (cooler due to cloud cover)
  consecutiveDryDaysBefore: 2,
  monsoonActiveDays: 18,
  monsoonBreakDays: 2,
  soilMoisture: 'High' as const,
  rainfallPctChange: 167,  // 280mm vs 105mm baseline → ~+167%
  tempOffset: -1.5,
};
